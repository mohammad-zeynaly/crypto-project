...
class QuestionsItem extends Component{
    ...
    questionsItemHandler(event){
        const changeQuestionsBox = this.state.isQuestionsBox = !this.state.isQuestionsBox
       ...
       let {title,caption} = this.props
        return(
            <div className="questions-item">
                        <button onClick={this.questionsItemHandler.bind(this)} className={`questions-item__btn ${this.state.isQuestionsBox ? 'questions-item__box--open' : ''}`}>
                        ...
                        <p className={`questions-item__description ${this.state.isQuestionsBox ? "questions-item__description--open" : ""}`}>
                            {caption}
                        </p>
            </div>
        )
