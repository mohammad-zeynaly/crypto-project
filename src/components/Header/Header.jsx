    ...
    return (
      <header className="header">
        ...
        <div className="header-shapes">
          <img
            className="header__shape header__shape--one"
            src="./assets/images/header-shape1.svg"
            alt="header shape"
          />
          <img
            className="header__shape header__shape--two"
            src="./assets/images/header-shape2.svg"
            alt="header shape"
          />
        </div>
