...
class RoadmapItem extends Component {
    ...
    render(){
        let {title,text,shapeClass,circleClass,detailImg,detailTitle,detailPercent,isContent} = this.props
        return(
        <>
            {isContent ?
                    ...
                    <span className={`roadmap-items__circle ${circleClass}`} ></span>
                        <a className="roadmap-item-link">
                            <span className="roadmap-item__icon">
                                    ...
                                    <span className="roadmap-item-link__number">{detailPercent}</span>
