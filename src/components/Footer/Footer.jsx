      ...
      footerList: [
        {
          ...
          text2: "نقشه راه",
          text3: "وایت پیپر",
          text4: "شبکه های مجازی",
          text5: "به ما ملحق شوید",
        },
        {
          id: 2,
          title: "پشتیبانی",
          text1: "تنظیمات و حریم خصوصی",
          text2: "راهنما و پیشتیبانی",
          text3: "قوانین و مقررات",
          text4: "24 ساعت و هفته پشتیبانی",
          text5: "پرسش و پاسخ",
        },
      ],
    };
      ...
      <footer className="footer">
        <div className="container footer-content">
          <div className="footer__wrapper">
            <div className="footer-option">
              ...
              <p className="footer-list__text">
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                استفاده از طراحان گرافیک چاپگرها و متون بلکه روزنامه است.
              </p>
              ...
              <ul className="news">
                ...
                <li className="news__item">
                  <div className="news-pic">
                    <img
                      ...
                      src="./assets/images/Footer/footer-1.jpg"
                      alt="news image"
                    />
                  </div>
                  <div className="news-content">
                    <a href="#" className="news__link">
                      {" "}
                      ویژگی های جدید بدون آسیب رساندن به آن انجام دهید ارائه
                      دهید{" "}
                    </a>
                ...
                <li className="news__item">
                  <div className="news-pic">
                    <img
                      className="news__image"
                      src="./assets/images/Footer/footer-2.jpg"
                      alt="news image"
                    />
                  </div>
                  <div className="news-content">
                    <a href="#" className="news__link">
                      معرفی 10 تا از بهترین صرافی ها و وب سایت ها
                    </a>
                    <span className="news__date">
                      <svg width="14" height="16" viewBox="0 0 14 16">
                        <path d="M3.25 8H4.75V9.5H3.25V8ZM13.75 3.5V14C13.75 14.3978 13.592 14.7794 13.3107 15.0607C13.0294 15.342 12.6478 15.5 12.25 15.5H1.75C0.9175 15.5 0.25 14.825 0.25 14V3.5C0.25 3.10218 0.408035 2.72064 0.68934 2.43934C0.970644 2.15804 1.35218 2 1.75 2H2.5V0.5H4V2H10V0.5H11.5V2H12.25C12.6478 2 13.0294 2.15804 13.3107 2.43934C13.592 2.72064 13.75 3.10218 13.75 3.5ZM1.75 5H12.25V3.5H1.75V5ZM12.25 14V6.5H1.75V14H12.25ZM9.25 9.5V8H10.75V9.5H9.25ZM6.25 9.5V8H7.75V9.5H6.25ZM3.25 11H4.75V12.5H3.25V11ZM9.25 12.5V11H10.75V12.5H9.25ZM6.25 12.5V11H7.75V12.5H6.25Z"></path>
        ...
        <div className="container">
          <p className="copy__right">
            طراحی و توسعه توسط محمد زینالی - فروردین 1402
          </p>
        </div>
      </footer>
    );
