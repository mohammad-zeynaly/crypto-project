                ...
                <div className="container">
                    <div className="download__wrapper">
                        ...
                        <div className="download-content">
                            ...
                            <div className="download-content__links">
                                <a href="#" className="download-content__link download-content__link--one">
                                 ...
                                 <a href="#" className="download-content__link download-content__link--two">
                        ...
                        <div className="download-banner">
                            <img className="download-banner__image download-banner__image--white" src="./assets/images/download-app/app-white.png" alt="" />
                            <img className="download-banner__image download-banner__image--dark" src="./assets/images/download-app/app-dark.png" alt="" />
                        </div>
